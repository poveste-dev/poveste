---
title: 'Single stories in Svelte — one component, one story'
description: 'The simplest kind of Svelte story, with one component rendered on its own and no variants.'
---
