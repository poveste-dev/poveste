...
// `.github/workflows/docs-site.yml`. Leaving it to be run by hand after a deploy
// meant it was not: #840's redirects shipped in 0.15.0 and the site served the
// previous deploy for a day (#911). Run it against a deploy preview before a
// redirect change lands.
