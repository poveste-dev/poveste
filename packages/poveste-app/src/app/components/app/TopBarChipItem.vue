<template>
  <!-- Without an href this is not a link, so `aria-label` on it is prohibited and
       it has no accessible role. Chip items are used both ways (#310). -->
  <a
    :role="$attrs['href'] ? undefined : 'button'"
